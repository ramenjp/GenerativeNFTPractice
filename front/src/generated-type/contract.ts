...
export interface Contract {
   ...
   * @param _initNotRevealedUri Type: string, Indexed: false
   */
  'new'(
    _name: string,
    _symbol: string,
    _initNotRevealedUri: string,
   ...
   * Type: function
   */
  getCurrentCost(overrides?: ContractCallOverrides): Promise<BigNumber>;
  /**
   * Payable: false
   * Constant: true
   * StateMutability: view
   * Type: function
   */
  getWhiteListCount(overrides?: ContractCallOverrides): Promise<BigNumber>;
  /**
   * Payable: false
   * Constant: true
   * StateMutability: view
   ...
   * Type: function
   */
  is_paused(overrides?: ContractCallOverrides): Promise<boolean>;
  /**
   * Payable: false
   * Constant: true
   * StateMutability: view
   * Type: function
   */
  is_presaleActive(overrides?: ContractCallOverrides): Promise<boolean>;
  /**
   * Payable: false
   * Constant: true
   * StateMutability: view
   * Type: function
   */
  is_revealed(overrides?: ContractCallOverrides): Promise<boolean>;
  /**
   * Payable: false
   * Constant: true
   * StateMutability: view
   ...
   * StateMutability: nonpayable
   * Type: function
   * @param _state Type: bool, Indexed: false
   */
  pause(
    _state: boolean,
    overrides?: ContractTransactionOverrides
   ...
   * Type: function
   * @param _mintAmount Type: uint256, Indexed: false
   */
  preMint(
   ...
   * Type: function
   */
  presale(overrides?: ContractCallOverrides): Promise<boolean>;
  /**
   * Payable: false
   * Constant: true
   * StateMutability: view
   * Type: function
   */
  publicMaxPerTx(overrides?: ContractCallOverrides): Promise<BigNumber>;
  /**
   * Payable: true
   * Constant: false
   * StateMutability: payable
   ...
   * Type: function
   */
  revealed(overrides?: ContractCallOverrides): Promise<boolean>;
  /**
   * Payable: false
   * Constant: false
   * StateMutability: nonpayable
   ...
   * StateMutability: nonpayable
   * Type: function
   * @param _notRevealedURI Type: string, Indexed: false
   */
  setNotRevealedURI(
   ...
   * Type: function
   * @param addr Type: address, Indexed: false
   * @param maxMint Type: uint256, Indexed: false
   */
  updateWL(
    addr: string,
